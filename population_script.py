...
def populate():
    ...
    rating_info = {'Rating 1': {'playlist': 'Thrash Bandicoot', 'user': jim, 'stars': 0.5, 'date': today, 'comment': 'Pile of garbage'}, 'Rating 2': {'playlist': 'Thrash Bandicoot', 'user': jim, 'stars': 3.5, 'date': today, 'comment': 'My kind of playlist!'}, 'Rating 3': {'playlist': 'Downtown Funk', 'user': fran, 'stars': 2.0, 'date': today, 'comment': 'Simply epic'}, 'Rating 4': {'playlist': "Now That's What I Call Romanian Folk-Pop", 'user': bob, 'stars': 4.0, 'date': today, 'comment': 'Awesome - I wish i was as cool as they are'}, 'Rating 5': {'playlist': 'Beard Appreciation Society Jams', 'user': bob, 'stars': 2.0, 'date': today, 'comment': 'This made my baby cry. And Im not even a father.'}, 'Rating 6': {'playlist': 'Relaxi-Ska-Hipster-Metal', 'user': bob, 'stars': 0.5, 'date': today, 'comment': 'Not my cup of tea'}, 'Rating 7': {'playlist': 'i luv you stacy plz come back', 'user': sue, 'stars': 0.5, 'date': today, 'comment': 'What did i ever do to you?'}, 'Rating 8': {'playlist': 'OK Pops', 'user': bob, 'stars': 2.0, 'date': today, 'comment': 'Not my cup of tea'}, 'Rating 9': {'playlist': 'Jazz in my Pants', 'user': sue, 'stars': 1.0, 'date': today, 'comment': 'I wouldnt play this to my worst enemy'}, 'Rating 10': {'playlist': 'boots n cats', 'user': sue, 'stars': 1.0, 'date': today, 'comment': 'What did i ever do to you?'}, 'Rating 11': {'playlist': 'I blue myself', 'user': bob, 'stars': 2.0, 'date': today, 'comment': 'What a shambles'}, 'Rating 12': {'playlist': 'OK Pops', 'user': fran, 'stars': 3.5, 'date': today, 'comment': 'Simply epic'}, 'Rating 13': {'playlist': 'OK Pops', 'user': sue, 'stars': 2.0, 'date': today, 'comment': 'What a shambles'}, 'Rating 14': {'playlist': 'Beard Appreciation Society Jams', 'user': jim, 'stars': 3.5, 'date': today, 'comment': 'Simply epic'}, 'Rating 15': {'playlist': 'Beard Appreciation Society Jams', 'user': sue, 'stars': 2.0, 'date': today, 'comment': 'This made my baby cry. And Im not even a father.'}, 'Rating 16': {'playlist': 'Blues Brothers', 'user': bob, 'stars': 4.5, 'date': today, 'comment': 'Got me right through my divorce, would recommend'}, 'Rating 17': {'playlist': 'Blues Brothers', 'user': bob, 'stars': 0.0, 'date': today, 'comment': 'What did i ever do to you?'}, 'Rating 18': {'playlist': 'Beard Appreciation Society Jams', 'user': sue, 'stars': 5.0, 'date': today, 'comment': 'Never heard anything like this before'}, 'Rating 19': {'playlist': 'Off-Beats', 'user': jim, 'stars': 3.0, 'date': today, 'comment': 'My kind of playlist!'}, 'Rating 20': {'playlist': 'Jims eclectic mix', 'user': sue, 'stars': 5.0, 'date': today, 'comment': 'This will always be my summer 2019 playlist'}, 'Rating 21': {'playlist': 'Off-Beats', 'user': sue, 'stars': 1.5, 'date': today, 'comment': 'Not my cup of tea'}, 'Rating 22': {'playlist': 'Beard Appreciation Society Jams', 'user': sue, 'stars': 4.0, 'date': today, 'comment': 'Never heard anything like this before'}, 'Rating 23': {'playlist': 'summer vibin', 'user': sue, 'stars': 0.5, 'date': today, 'comment': 'I wouldnt play this to my worst enemy'}, 'Rating 24': {'playlist': 'Jims eclectic mix', 'user': fran, 'stars': 3.5, 'date': today, 'comment': 'Simply epic'}, 'Rating 25': {'playlist': 'Cut My Life Into Pizzas, This Is My Plastic Fork', 'user': fran, 'stars': 2.0, 'date': today, 'comment': 'Too loud'}, 'Rating 26': {'playlist': 'NedBeatz', 'user': fran, 'stars': 4.5, 'date': today, 'comment': 'Simply epic'}, 'Rating 27': {'playlist': 'I blue myself', 'user': jim, 'stars': 1.5, 'date': today, 'comment': 'Not my cup of tea'}, 'Rating 28': {'playlist': 'Blues Brothers', 'user': bob, 'stars': 3.0, 'date': today, 'comment': 'Never heard anything like this before'}, 'Rating 29': {'playlist': 'Relaxi-Ska-Hipster-Metal', 'user': jim, 'stars': 1.5, 'date': today, 'comment': 'Pile of garbage'}, 'Rating 30': {'playlist': 'Sounds of the 70s', 'user': sue, 'stars': 2.5, 'date': today, 'comment': 'My kind of playlist!'}, 'Rating 31': {'playlist': 'i luv you stacy plz come back', 'user': jim, 'stars': 3.5, 'date': today, 'comment': 'Pretty decent'}, 'Rating 32': {'playlist': 'i luv you stacy plz come back', 'user': fran, 'stars': 4.0, 'date': today, 'comment': 'Loved it - such drama, such mourning.'}}
